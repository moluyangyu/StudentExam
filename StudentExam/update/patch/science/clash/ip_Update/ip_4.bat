...
cd /d %~dp0
..\..\wget --no-check-certificate https://www.githubip.xyz/Alvin9999/pac2/master/clash/2/config.yaml

if exist config.yaml goto startcopy

..\..\wget --no-check-certificate https://fastly.jsdelivr.net/gh/Alvin9999/pac2@latest/clash/2/config.yaml
