...
..\..\wget --no-check-certificate https://www.githubip.xyz/Alvin9999/pac2/master/SS-Kcptun/ssconfig.txt

if exist ssconfig.txt goto startcopy

..\..\wget --no-check-certificate https://fastly.jsdelivr.net/gh/Alvin9999/pac2@latest/SS-Kcptun/ssconfig.txt
...
ECHO.&ECHO.已更新SS-plugin配置文件,请按回车键或空格键启动程序！ &PAUSE >NUL 2>NUL
exit