...
cd /d %~dp0
..\..\wget --no-check-certificate https://www.githubip.xyz/Alvin9999/PAC/master/2/guiNConfig.json

if exist guiNConfig.json goto startcopy

..\..\wget --no-check-certificate https://fastly.jsdelivr.net/gh/Alvin9999/PAC@latest/2/guiNConfig.json
