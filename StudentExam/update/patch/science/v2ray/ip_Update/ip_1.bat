...
cd /d %~dp0
..\..\wget --no-check-certificate https://gitlab.com/free9999/ipupdate/-/raw/master/v2rayN/guiNConfig.json

if exist guiNConfig.json goto startcopy

..\..\wget --no-check-certificate https://www.githubip.xyz/Alvin9999/PAC/master/1/guiNConfig.json
