...
cd /d %~dp0
..\..\wget --no-check-certificate https://www.githubip.xyz/Alvin9999/pac2/master/singbox/config.json

if exist config.json goto startcopy

..\..\wget --no-check-certificate https://fastly.jsdelivr.net/gh/Alvin9999/pac2@latest/singbox/config.json
