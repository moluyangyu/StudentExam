...
cd /d %~dp0
..\..\wget --no-check-certificate https://gitlab.com/free9999/ipupdate/-/raw/master/singbox/config.json

if exist config.json goto startcopy

..\..\wget --no-check-certificate https://www.githubip.xyz/Alvin9999/pac2/master/singbox/1/config.json
